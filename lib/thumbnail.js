// lib/thumbnail.js
//fungsi untuk save ke database thumbnail

import { saveThumb } from '../db/thumbnails.js'
import { getRawMessageById } from '../db/rawMessage.js'
import { formatDuration, getUrlExpiry, getMediaAgeMs, waMediaUrl } from './utils.js'
...
export { REFRESH_THRESHOLD_MS, THUMB_FIELDS, pickFields, toBase64Field }